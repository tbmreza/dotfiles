...
vim.cmd([[
	...
	function! FiletypeJavascript()
		vnoremap <leader>dd yoconsole.log(<c-r>0);<left><left><esc>
		nnoremap <leader>dd yiwoconsole.log(<c-r>0);<left><left><esc>
	endfunction
	...
	autocmd filetype volt call FiletypeJavascript()
